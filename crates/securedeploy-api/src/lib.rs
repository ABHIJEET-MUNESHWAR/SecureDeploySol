//! GraphQL API surface for the SecureDeploySol off-chain service.
#![forbid(unsafe_code)]

pub mod schema;
pub mod state;

pub use schema::{build_schema, SecureDeploySchema};
...
pub fn router(schema: SecureDeploySchema) -> Router {
    Router::new()
        .route(
            "/graphql",
